...
describe("Delete Recado usecase", () => {
    beforeAll(async () => {
    ...
    test("Deveria retornar 404 se o recado nao for encontrado.", async () => {
        ...
        jest.spyOn(RecadoRepository.prototype, "delete").mockResolvedValue(0)
    ...
    test("Deveria retornar 200 se o recado for deletado com sucesso", async () => {
        jest.spyOn(userDatabase.prototype, "get").mockResolvedValue(User)
        jest.spyOn(RecadoRepository.prototype, "delete").mockResolvedValue(1)
